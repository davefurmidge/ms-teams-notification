<p align="center">
  <a href="https://github.com/davefurmidge/ms-teams-notification/actions"><img alt="ms-teams-notification status" src="https://github.com/davefurmidge/ms-teams-notification/workflows/Build%20&%20Test/badge.svg"></a>
</p>
  ...
  build:
    ...
    steps:
      ...
      - name: Notify dedicated teams channel
        uses: davefurmidge/ms-teams-notification@main
        with:
